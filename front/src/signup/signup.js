...
function blankScanner() {
  if (signUpNickInput.value.length <= 0) return "nick";
  else if (signUpPasswordInput.value.length <= 0) return "pswd";
  else if (signUpPasswordReInput.value.length <= 0) return "pwre";
  else return 200;
}
